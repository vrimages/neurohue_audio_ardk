...
namespace Niantic.ARDKExamples.Helpers
{
  ...
  ///   hit location.
  /// </summary>
  public class ARHitTester2: MonoBehaviour
  {
    ...
    private void TouchBegan(Touch touch)
    {
      if(startPlace == 1){
        ...
        if(didPlace == 0)
        {
          ...
          cylinder = Instantiate(PlacementObjectPf, hitPosition, Quaternion.identity);
          _placedObjects.Add(cylinder);
    ...
    public void Submit()
    {
        ...
        //new Vector3(cylinder.transform.x, cylinder.transform.y, cylinder.transform.z);
